...
public class GridNFragment extends Fragment {
    ...
    public String [] prgmNameList={"Facultad de Arquitectura, Urbanismo y Artes","Facultad de Ciencias","Facultad de Ingeniería Ambiental",
            "Facultad de Ingeniería Civil","Facultad de Ingeniería Eléctrica, Electrónica y Telecomunicaciones","Facultad de Ingeniería Económica, Estadística y CCSS",
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_n_facus, container, false);
